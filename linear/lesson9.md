...
$$
\left(\begin{matrix}1 & -3 \\  2 & -1 \: \end{matrix} \right| \: \left.\begin{matrix}1 & 0 \\ 0 & 1 \end{matrix}\right)
$$

$-2 \cdot$ R1 + R2:

$$
\left(\begin{matrix}1 & -3 \\  0 & 5 \: \end{matrix} \right| \: \left.\begin{matrix}1 & 0 \\ -2 & 1\end{matrix}\right)
$$

$\frac{1}{5} \cdot$ R2:

$$
\left(\begin{matrix}1 & -3 \\  0 & 1 \: \end{matrix} \right| \: \left.\begin{matrix} 1 & 0 \\ -\frac{2}{5} & \frac{1}{5} \end{matrix}\right)
$$

Now eliminate the top right with 3R2 + R1:

$$
\left(\begin{matrix}1 & 0 \\   0 & 1 \: \end{matrix} \right| \: \left.\begin{matrix} -\frac{1}{5} & \frac{3}{5} \\ -\frac{2}{5} & \frac{1}{5} \end{matrix}\right)
$$
