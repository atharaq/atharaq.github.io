# Discrete Mathematics Lesson 18: Equivalence Relations
{:.no_toc}
...
* Presentation 2 will be done via **VoiceThread** instead of in class. This will be due on Friday, April 27.
* Group Projects: decide on a group by next week. If you know who you want to work with, let me know. If not, I'll put you in a group by the end of next week.
   * Topics: check Moodle for possible topics. Let me know your group's topic by 4/24.
   * Group Presentation: in class on 5/1.
   * Final Paper: due online on 5/8.
...
Recall that we discussed "formalism" in mathematics earlier in the semester. Below are some thoughts I wanted to share about this kind of question of philosophy of mathematics.
