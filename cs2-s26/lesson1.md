...
At this point, you should be able to run a simple program. I'd like to you submit a program ([via GitHub Classroom](https://classroom.github.com/a/EFGigMS2)) just to make sure you can. The program should output your name. (*This is the homework you were already assigned from last time, just reminding you to do this.*)
...
If you click on it, it should say your GitHub user name, or it could ask you to sign in to GitHub to use GitHub Classroom. Click that and follow the instructions to sign in. Once you've signed it, go back to the [GitHub Classroom assignment](https://classroom.github.com/a/EFGigMS2) and try to click the "Open in VSCode" button again, this should work now.
