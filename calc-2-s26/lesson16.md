...
* Written HW 3 due Monday
* MyOpenMath 4 due next Thursday
* Presentation 2: 4/9 (next Thurs), 4/13, 4/16, and 4/20. Let's make a schedule.

## Advising

Next week is advising week. Make an appointment with your advisor.

* Math/CS Core courses next semester: Calc 1, CS1, Calc 3, Discrete
* Electives next semester: Origins of Math, Data Science/Stats (new course: online/hybrid format)
